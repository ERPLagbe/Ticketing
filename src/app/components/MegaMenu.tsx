        ...
        <div className="grid grid-cols-4 gap-12">
          ...
          <div className="col-span-1">
            ...
            {showExploreAll && (
              <Link
                to="/search"
                className="inline-flex items-center gap-1 text-base text-gray-900 hover:text-[#FF6F61] mt-6 relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-[#FF6F61] after:transition-[width] after:duration-150 after:ease-in hover:after:w-full"
              >
                Explore all
